...
# define COUNT_15S_ACLK_32(uint16_t) 61440# define COUNT_10MS_3MHZ(uint16_t) 120000

///100us count at 48MHz DCO frequency
# define COUNT_100US_48MHZ(uint16_t) 4800
///1ms count at 48MHz DCO frequency
# define COUNT_1MS_48MHZ(uint16_t) 48000# define COUNT_1S_48MHZ(uint32_t) 48000000
# endif /* TIMER_H_ */
