 ...
 *  shift register. Val is continuously decimal shifted right and the least
 *  significant digit is used as the index of a string for the next value of buf.
 *   A pointer to the firstvalue of buffer is returned and can be used in generic
 ...
 *  mode with multiple sample and conversion. The ADC will be taking a Vref of 3.3V
 *  as well
 *
 *  \return void
 */
